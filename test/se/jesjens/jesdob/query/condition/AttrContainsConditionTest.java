 ...
 * @author jenss
 */
public class AttrContainsConditionTest {

  /**
   * Test of isTrue method, of class AttrContainsCondition.
   */
  @Test
  public void testIsTrue() {
    ...
    ICondition condition = new AttrContainsCondition("attr1", "number 1");
